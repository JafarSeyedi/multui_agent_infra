...
from engines.document.models.osdm_models import DecisionLogicType
...
from engines.document.writers.ksdm_writers.process_mining.jprm_writer import JprmWriter
from engines.document.writers.ksdm_writers.process_mining.yprm_writer import YprmWriter
