...
async def test_mdx_parse(sample_mdx_text):
    from engines.document.parsers.ksdm_parsers.query_models import MdxParser
...
async def test_mdx_write_roundtrip(sample_mdx_text):
    from engines.document.parsers.ksdm_parsers.query_models import MdxParser
    from engines.document.writers.ksdm_writers.query_models import MdxWriter
...
async def test_dax_parse(sample_dax_text):
    from engines.document.parsers.ksdm_parsers.query_models import DaxParser
...
async def test_sql_tabular_parse(sample_sql_tabular_text):
    from engines.document.parsers.ksdm_parsers.query_models import SqlTabularParser
...
async def test_m_parse(sample_m_text):
    from engines.document.parsers.ksdm_parsers.query_models import PowerQueryMParser
...
async def test_jpql_parse(sample_jpql_text):
    from engines.document.parsers.ksdm_parsers.query_models import JpqlParser
...
async def test_oql_parse(sample_oql_text):
    from engines.document.parsers.ksdm_parsers.query_models import OqlParser
...
async def test_graphql_parse(sample_graphql_query_text):
    from engines.document.parsers.ksdm_parsers.query_models import GraphqlQueryParser
...
async def test_xmla_parse_execute():
    from engines.document.parsers.ksdm_parsers.query_models import XmlaQueryParser
