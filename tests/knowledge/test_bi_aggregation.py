...
async def test_mondrian_parse(sample_mondrian_xml):
    from engines.document.parsers.ksdm_parsers.bi_aggregation import MondrianSchemaParser
...
async def test_tmsl_parse(sample_tmsl_json):
    from engines.document.parsers.ksdm_parsers.bi_aggregation import TmslParser
...
async def test_cdm_parse(sample_cdm_json):
    from engines.document.parsers.ksdm_parsers.bi_aggregation import CdmParser
...
async def test_calcite_parse(sample_calcite_json):
    from engines.document.parsers.ksdm_parsers.bi_aggregation import CalciteParser
...
async def test_awxml_parse(sample_awxml):
    from engines.document.parsers.ksdm_parsers.bi_aggregation import AwxmlParser
...
async def test_sap_cds_parse(sample_sap_cds):
    from engines.document.parsers.ksdm_parsers.bi_aggregation import SapCdsParser
...
async def test_cognos_fmf_parse(sample_cognos_fmf):
    from engines.document.parsers.ksdm_parsers.bi_aggregation import CognosFmfParser
...
async def test_mondrian_write_roundtrip(sample_mondrian_xml):
    from engines.document.parsers.ksdm_parsers.bi_aggregation import MondrianSchemaParser
    from engines.document.writers.ksdm_writers.bi_aggregation import MondrianSchemaWriter
...
async def test_tmsl_write_roundtrip(sample_tmsl_json):
    from engines.document.parsers.ksdm_parsers.bi_aggregation import TmslParser
    from engines.document.writers.ksdm_writers.bi_aggregation import TmslWriter
...
async def test_cwm_parse():
    from engines.document.parsers.ksdm_parsers.bi_aggregation import CwmParser
...
async def test_xmla_discover_parse():
    from engines.document.parsers.ksdm_parsers.query_models import XmlaQueryParser as XmlaParser
