...
from .docx_models import DOCXMathElement
from .docx_models import DOCXRunProperties
from .docx_utils import get_element_text
...
class OMMLParser:
    ...
    def parse_math_paragraph(self, math_para_elem: ET.Element) -> DOCXMath | None:
        """
    ...
    def parse_math(self, math_elem: ET.Element, is_display: bool = False) -> DOCXMath | None:
        """
    ...
    def parse_math_from_xml(self, xml_string: str, is_display: bool = False) -> DOCXMath | None:
        """
    ...
    def _parse_math_element(self, elem: ET.Element) -> DOCXMathElement | None:
        """
    ...
    def _parse_math_container(self, elem: ET.Element) -> DOCXMathElement | None:
        """
    ...
    def _parse_math_run(self, elem: ET.Element) -> DOCXMathElement | None:
    ...
    def _parse_fraction(self, elem: ET.Element) -> DOCXMathElement | None:
    ...
    def _parse_radical(self, elem: ET.Element) -> DOCXMathElement | None:
    ...
    def _parse_nary(self, elem: ET.Element) -> DOCXMathElement | None:
    ...
    def _parse_accent(self, elem: ET.Element) -> DOCXMathElement | None:
    ...
    def _parse_bar(self, elem: ET.Element) -> DOCXMathElement | None:
    ...
    def _parse_box(self, elem: ET.Element) -> DOCXMathElement | None:
    ...
    def _parse_border_box(self, elem: ET.Element) -> DOCXMathElement | None:
    ...
    def _parse_delimiter(self, elem: ET.Element) -> DOCXMathElement | None:
    ...
    def _parse_equation_array(self, elem: ET.Element) -> DOCXMathElement | None:
    ...
    def _parse_function(self, elem: ET.Element) -> DOCXMathElement | None:
    ...
    def _parse_group_character(self, elem: ET.Element) -> DOCXMathElement | None:
    ...
    def _parse_limit(self, elem: ET.Element, limit_type: str) -> DOCXMathElement | None:
    ...
    def _parse_matrix(self, elem: ET.Element) -> DOCXMathElement | None:
    ...
    def _parse_phantom(self, elem: ET.Element) -> DOCXMathElement | None:
    ...
    def _parse_pre_sub_sup(self, elem: ET.Element) -> DOCXMathElement | None:
    ...
    def _parse_sub_sup(self, elem: ET.Element, ss_type: str) -> DOCXMathElement | None:
    ...
    def _extract_text_from_element(self, elem: DOCXMathElement | None) -> str:
