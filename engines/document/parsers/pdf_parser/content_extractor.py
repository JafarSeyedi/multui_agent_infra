...
from .layout_analyzer import LayoutBlock, PageLayout
...
class ExtractedText:
    ...
    structural_type: Optional[str] = None  # paragraph, heading, caption, etc.
...
class ContentExtractor:
    ...
    def extract_all(self, 
                   layout: Optional[List[PageLayout]] = None,
                   structure: Optional[List[StructuralElement]] = None) -> Dict[str, Any]:
        """
    ...
    def extract_text(self, 
                    layout: Optional[List[PageLayout]] = None,
                    structure: Optional[List[StructuralElement]] = None) -> List[ExtractedText]:
        """
        استخراج متن از PDF
