...
class LatexParser(BaseDocumentParser):
    ...
    def _process_latex_line(self, line: str, line_num: int) -> str | None:
        """پردازش یک خط LaTeX"""
        # حذف کامنت‌ها
    ...
    def _process_verbatim_line(self, line: str) -> str | None:
    ...
    def _process_section_commands(self, line: str) -> bool | None:
    ...
    def _process_math_commands(self, line: str) -> bool | None:
    ...
    def _process_list_commands(self, line: str) -> bool | None:
        """پردازش دستورات لیست"""
        # بررسی \item
    ...
    def _process_table_commands(self, line: str) -> bool | None:
        """پردازش دستورات جدول"""
        # بررسی خطوط جدول
    ...
    def _process_image_commands(self, line: str) -> bool | None:
    ...
    def _process_quote_commands(self, line: str) -> bool | None:
    ...
    def _process_code_commands(self, line: str) -> bool | None:
        """پردازش دستورات کد"""
    ...
    def _extract_math_content(self, line: str) -> str | None:
        """استخراج محتوای ریاضی"""
    ...
    def _create_image_element(self, filename: str, options: str | None = None) -> None:
        """ایجاد المنت تصویر"""
