...
from .media_types import MediaType, MEDIA_TYPES
...
class BaseDocument(BaseModel):
    ...
    decompressed_size: Optional[int] = None #"حجم اصلی قبل از فشرده‌سازی (بایت)"
...
class BinaryPayload(BaseModel):
    ...
    bytes_content: Optional[bytes] = None  # برای داده‌های باینری خام
    data: Optional[str] = None     # encoded_data برای داده‌های کدگذاری شده
    ...
    compression_algorithm: Optional[str] = None  # "gzip", "zlib", "brotli"
    original_size: Optional[int] = None  # اندازه قبل از فشرده‌سازی    
