...
from ...usdm_writers.shared.drawingml_helpers import write_effects, write_fill, write_line, write_rich_text_body, write_scene3d, write_sp3d
...
def write_picture(img: ImageContent, element_id: str = "1") -> Element:
    ...
    SubElement(blipFill, f"{A}blip", {f"{R}embed": img.src})
