...
class PDFOptimizer:
    ...
    def _optimize_single_image(self, image_obj: Dict, options: Dict) -> Optional[Dict]:
        """
        بهینه‌سازی یک تصویر
    ...
    def _extract_image_data(self, image_obj: Dict) -> Tuple[Optional[bytes], Dict]:
        """
    ...
    def _optimize_jpeg_image(self, image_data: bytes, image_info: Dict, options: Dict) -> Optional[bytes]:
        """
    ...
    def _optimize_png_image(self, image_data: bytes, image_info: Dict, options: Dict) -> Optional[bytes]:
        """
    ...
    def _optimize_tiff_image(self, image_data: bytes, image_info: Dict, options: Dict) -> Optional[bytes]:
        """
