...
class MetadataWriter:
    """Class for writing PDF Metadata"""
    ...
    def validate_metadata(self, metadata_dict: dict[str, Any]) -> list[str]:
            ...
            if date_field in metadata_dict:
                ...
                if isinstance(value, str):
                    try:
                        ...
                        warnings.append(f"Date format for {date_field} is invalid: {value}")
        ...
        for string_field in string_fields:
            if string_field in metadata_dict and metadata_dict[string_field]:
                ...
                if len(value) > 255:
                    warnings.append(f"Field {string_field} is too long ({len(value)} characters)")
