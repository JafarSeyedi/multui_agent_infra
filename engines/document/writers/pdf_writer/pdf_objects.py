    ...
    def to_bytes(self) -> bytes:
        ...
        for key, value in self.entries.items():
            if isinstance(value, str):
                # UTF-16 strings for Persian/Farsi support
...
#     # Add Persian text
#     writer.add_text(page1, "Hello World!", 100, 700, font_size=20)
#     writer.add_text(page1, "This is a test PDF document.", 100, 650, font_size=14)
#     writer.add_text(page1, "This is English text.", 100, 600, font_size=14)

#     # Save file
#     writer.save("test_output.pdf")
#     print("PDF file created successfully: test_output.pdf")
