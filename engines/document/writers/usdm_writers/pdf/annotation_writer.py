...
class Annotation:
    ...
    color: tuple[float, float, float] = (1, 1, 0)  # Color (default yellow)
...
class AnnotationWriter:
    """PDF annotations writer"""

    def __init__(self) -> None:
        self.annotations: list[Annotation] = []
        self.next_object_num = 1
        self.annotation_map: dict[str, int] = {}  # Maps annotation_id to object number
    ...
    def create_highlight_annotation(self, page_number: int, rect: tuple[float, float, float, float],
        ...
        annotation = Annotation(
            ...
            rect=rect,
            contents=contents,
            color=kwargs.pop('color', (1, 1, 0)),  # Default yellow
            **kwargs
        )
        self.add_annotation(annotation)
        return annotation
    ...
    def create_fileattachment_annotation(self, page_number: int,
        ...
        annotation = Annotation(
            ...
            custom_data={
                ...
                'file_data': file_data.hex()  # Stored as hex
            },
            **kwargs
        )
        self.add_annotation(annotation)
