# engines/document/writers/msdm_writers/proto_msdm_writer.py
"""
...
class ProtoWriter(BaseMSDMWriter):
    ...
    def _datatype_to_proto(self, dt: DataType) -> str:
        if dt.base == ScalarType.REF and dt.ref_entity:
            return dt.ref_entity.name or "Unknown"
    ...
    def _find_entity_by_name(self, doc: MSDMDocument, name: str) -> Entity | None:
