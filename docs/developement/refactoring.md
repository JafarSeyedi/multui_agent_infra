...
1. we have ssdm models that are engine specific models, so the model and writers and parsers need to be in the folder structure inside engines/communication.
